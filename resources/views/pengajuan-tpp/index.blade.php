        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            @role('Admin|Operator TPP')
                <div class="bg-white rounded-xl shadow-lg border border-gray-200">
                    ...
                    <div class="p-6">
                        <form method="GET" action="{{ route('pengajuan-tpp.lanjutkan') }}" class="space-y-6" x-data="{ submitting: false }" @submit="submitting = true">
                            ...
                            <div class="flex justify-end pt-4">
                                <button type="submit" :disabled="submitting"
                                    class="inline-flex items-center justify-center px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg shadow-md hover:shadow-lg transition-all duration-200 transform hover:scale-105 disabled:opacity-75 disabled:cursor-not-allowed">
                                    ...
                                    <svg x-show="!submitting" class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M9 5l7 7-7 7" />
                                    </svg>
                                </button>
